...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT Username, Lastname, Firstname, Middlename, Suffix, Contactnumber, Sex, Address, Citizenship, EmailAddress FROM student WHERE role ='Student' AND Enroll_Status = 'enrolled'
    ...
    <div class ="main-container">
        <div class = "nav-container">
               ...
               <div class="nav_links">
				...
				<a href ="di_reports.php">Reports</a>
				<a href ="di_assesment.php">Assesment</a>
			</div>
            </nav>
        </div>
    </div>
    <div class="content-container">
       <h4 class="description">Accessment</h4>
