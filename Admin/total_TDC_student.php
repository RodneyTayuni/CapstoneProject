...
//AGE get Data chart
$queryAgeStudent = "SELECT idStudent, Firstname, Lastname, Birthdate FROM student WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled'";
...
$CountGender = "SELECT Sex, COUNT(*) as count FROM student WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled' GROUP BY Sex";
...
//City get DataChart
$queryStdCity = "SELECT City, IFNULL(COUNT(*), 0) AS StudentCount FROM student WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled' GROUP BY City";
...
$queryDistinctCities = "SELECT DISTINCT City FROM student WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled'";
...
$queryGender = "SELECT Sex, COUNT(*) AS GenderCount FROM student WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled' GROUP BY Sex";
...
<body>
    ...
    <a href="" id="logoutLink"><i class="fas fa-sign-out-alt"></i> Log Out</a>
        ...
        <div class="main_content">
            <header style="margin-bottom:1%;"><h2>TOTAL TDC STUDENTS</h2></header>
            <div class="con1">
            <div class="students">
                <div class="male">
...
if (isset($_GET['search_query'])) {
    ...
    $sql = "SELECT * FROM student
           WHERE TDC = 'Enrolling' and TDC_Cert_approve IS NULL and Enroll_Status = 'enrolled';";
}
