...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["Add_SchedTDC"]) && !empty($_POST["Add_SchedTDC"])) {
        try {
            $schedule1 = $_POST["TDC_Date1"];
            $schedule2 = $_POST["TDC_Date2"];
    
            $admin_scheduleTime1 = $_POST["TimeTDC1"];
            $admin_scheduleTime2 = $_POST["TimeTDC2"];
            ...
            if (!empty($schedule1) && !empty($schedule2)) {
                ...
                $sql_AddSchedule = "INSERT INTO `tdc_schedule` (`schedule1`, `schedule2`, `time1`, `time2`) VALUES (?, ?, ?, ?)";
