...
try {
    $stmt = $conn->prepare("SELECT
                                u896821908_bts.student_payment.username,
                                u896821908_bts.student_payment.payment_type,
                                u896821908_bts.student_payment.Total_paid,
                                u896821908_bts.student_enrolled.TDC,
                                u896821908_bts.student_enrolled.DEP,
                                u896821908_bts.student_enrolled.`PDC-MOTOR`,
                                u896821908_bts.student_enrolled.`PDC-CAR`
                            FROM
                                u896821908_bts.student_enrolled
                            INNER JOIN
                                u896821908_bts.student_payment ON u896821908_bts.student_payment.username = u896821908_bts.student_enrolled.Username
                            WHERE
                                u896821908_bts.student_enrolled.Username = :username
                            ORDER BY
                                u896821908_bts.student_payment.idstudent_payment ASC
                            LIMIT 1");
    ...
    if ($row) {
        ...
        echo "No payment data found for the username: $username";
    }
...
$pdf->Cell(30,5,$paymentType,0,1);  

if ($paymentType === 'five payment') {
    $pdf->Cell(5,2,'',0,1);
    $pdf->Cell(5,5,'',0,0);
