		...
		<div class="fillup">
			<div class="inside">
				...
				<form id="GCASH_Form" enctype="multipart/form-data">
					...
					<input type="hidden" name="student_id_GCASH" value="<?php echo $_SESSION['STD_idStudent_GCASH']?>">
					<input type="hidden" name="student_username_GCASH" value="<?php echo $_SESSION['STD_USERNAME_GCASH']?>">

					<input type="text" id="student_name" name="student_name"
						value="<?php echo $_SESSION['STD_NAME_GCASH']; ?>">
					<br><br>
